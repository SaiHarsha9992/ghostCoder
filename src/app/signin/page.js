...
export default function SignIn() {
  ...
  return (
    <div className="bg-[#1a2629] text-white min-h-screen flex flex-col items-center justify-center">
      <Header />
      <main className="flex-grow flex flex-col lg:flex-row lg:justify-between items-center w-full max-w-5xl mx-auto p-2">
        {/* Left: Sign-In Form */}
        <div className="flex flex-col lg:items-end justify-center w-full max-w-md">
          <div className="flex flex-col items-center justify-center p-4 px-20 bg-[#2a3d41] rounded-lg shadow-lg">
            <div className="text-center px-8">
              ...
              <span className="text-[5px] ">
                Sign in with your email and username if your already registered
              </span>
            </div>

            {/* Manual Sign-In Form */}
            <form onSubmit={handleManualSignIn} className="w-full mt-4">
              <div className="mb-4">
                <label
                  htmlFor="email"
                ...
                <input
                  ...
                  className="mt-2 block w-full px-4 py-2 rounded-md border bg-[#1a2629] border-gray-300 shadow-sm"
                />
              </div>
              ...
              <div>
                <button
                  type="submit"
                  className="w-full py-2 bg-white text-black rounded-md hover:shadow-md focus:outline-none"
                >
                  Sign in
                </button>
              </div>
            ...
            <div className="flex items-start my-2">
              <span className="mx-2 text-sm text-gray-400">
                ...
                <a
                  href="/signup"
                  className="ml-2 font-extrabold text-white hover:underline"
                >
                  SignUp?
                </a>
              </span>
            ...
            <div className="flex items-center my-4">
              ...
              <span className="mx-2 text-sm text-white">Or continue with</span>
              <div className="w-full h-px bg-gray-300"></div>
            </div>
