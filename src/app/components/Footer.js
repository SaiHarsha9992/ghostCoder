export default function Footer() {
  return (
    <footer className="bg-[#1a2629] text-center text-white py-8">
      <div className="container mx-auto">
        <div className="flex flex-col items-center justify-center space-y-6">
          ...
          <div className="flex space-x-6">
            <a href="https://github.com/SaiHarsha9992" target="_blank">
              <button
                type="button"
            ...
            <a
              href="https://www.instagram.com/kedarinadh_sai_harsha_gadu/"
              target="_blank"
            >
              <button
                type="button"
